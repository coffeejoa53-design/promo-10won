...
/* 새 형식 비밀키(sb_secret_...)는 apikey 헤더만, 예전 service_role JWT 는 Authorization 도 같이 */
...
async function rest(path, opts) {
  ...
  const headers = Object.assign(authHeaders(e.key), {
...
async function rpc(name, args) {
  ...
  const r = await fetch(e.url + "/rest/v1/rpc/" + name, {
    method: "POST",
    headers: Object.assign(authHeaders(e.key), { "Content-Type": "application/json" }),
